...
Ключевые моменты:
- Промис может находиться в одном из трех состояний: pending, fulfilled или rejected.
- После создания промис находится в состоянии pending.
- Когда асинхронная операция завершается, промис переходит в состояние fulfilled или rejected.
